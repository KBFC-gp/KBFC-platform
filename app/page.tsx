    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/90 border-b border-gold/30 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <button className="md:hidden text-gold text-2xl">â˜°</button>
        </div>
      </nav>
      {/* HERO */}
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-gold/80 text-sm md:text-base mb-10 tracking-widest">
            UNE CARAÃ BE â€¢ UNE COMMUNAUTÃ‰ â€¢ UNE PASSION CANINE â€¢ UNE CULTURE Ã€ PARTAGER
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-[#1a1400] to-[#0d0d0d] border-2 border-gold rounded-2xl overflow-hidden mb-8">
            <div className="bg-gold text-black text-center py-2 text-sm font-bold tracking-widest">
              â˜… Ã‰VÃ‰NEMENT PRINCIPAL 2026 â˜…
            </div>
            <div className="p-8 md:p-12">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                  <div className="text-gold text-sm font-bold mb-2">SHOW MULTI-RACES DES CARAÃ BES</div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <div className="bg-black/50 rounded-xl p-4 border border-gold/20">
                      <div className="text-gold text-xs mb-1">ðŸŒ OUVERT Ã€</div>
                      <div className="text-white font-bold">Toute la CaraÃ¯be</div>
                ...
                <div className="md:w-64 text-center">
                  <div className="bg-black/50 border border-gold/30 rounded-2xl p-6">
                    ...
                    <div className="text-gray-400 text-xs mt-1">Multi-races des CaraÃ¯bes</div>
      ...
      <footer className="bg-[#050505] border-t border-gold/20 py-12 px-4">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-400 text-sm">
                  ...
                  <li><Link href="/adhesion" className="hover:text-gold transition-colors">AdhÃ©sion</Link></li>
                  <li><Link href="/evenements" className="hover:text-gold transition-colors">Ã‰vÃ©nements</Link></li>
          ...
          <div className="border-t border-gold/10 pt-6 text-center text-gray-600 text-xs">
            Â© 2026 Karibbean Bully Fanatics Club â€” Tous droits rÃ©servÃ©s.
          </div>
        </div>
      </footer>
