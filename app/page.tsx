    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/90 border-b border-gold/30 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <button className="md:hidden text-gold text-2xl">menu</button>
        </div>
      </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          <img src="/logo.png.PNG" alt="KBFC" className="h-48 w-48 mx-auto mb-8 object-contain drop-shadow-2xl" />
          <h1 className="text-5xl md:text-7xl font-black text-gold mb-4 tracking-wider">KBFC</h1>
          ...
          <p className="text-gold/80 text-sm md:text-base mb-10 tracking-widest">
            UNE CARAIBE - UNE COMMUNAUTE - UNE PASSION CANINE - UNE CULTURE A PARTAGER
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white mt-2">
              NOS PROCHAINS <span className="text-gold">EVENEMENTS</span>
            </h2>
          </div>
          <div className="bg-gradient-to-br from-[#1a1400] to-[#0d0d0d] border-2 border-gold rounded-2xl overflow-hidden mb-8">
            <div className="bg-gold text-black text-center py-2 text-sm font-bold tracking-widest">
              EVENEMENT PRINCIPAL 2026
            </div>
            <div className="p-8 md:p-12">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                  <div className="text-gold text-sm font-bold mb-2">SHOW MULTI-RACES DES CARAIBES</div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Link href="/evenements" className="bg-gold text-black px-6 py-3 rounded-xl font-bold text-center hover:bg-yellow-500 transition-colors">
                      Je m inscris
                    </Link>
                    <Link href="/evenements" className="border border-gold text-gold px-6 py-3 rounded-xl font-bold text-center hover:bg-gold/10 transition-colors">
                      En savoir plus
                    </Link>
                  </div>
                </div>
      ...
      <section className="py-20 px-4 bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            <div className="bg-[#111] border border-gold/20 rounded-2xl p-6 hover:border-gold/60 transition-colors">
              <div className="text-4xl mb-3">dog</div>
              <div className="text-gold font-bold text-sm mb-1">Enregistrer vos chiens</div>
              <div className="text-gray-400 text-xs">Gerez et valorisez vos compagnons</div>
            </div>
            <div className="bg-[#111] border border-gold/20 rounded-2xl p-6 hover:border-gold/60 transition-colors">
              <div className="text-4xl mb-3">cal</div>
              <div className="text-gold font-bold text-sm mb-1">Participer aux evenements</div>
              <div className="text-gray-400 text-xs">Shows, expositions, rencontres et plus</div>
            </div>
            <div className="bg-[#111] border border-gold/20 rounded-2xl p-6 hover:border-gold/60 transition-colors">
              <div className="text-4xl mb-3">card</div>
              <div className="text-gold font-bold text-sm mb-1">Carte de membre</div>
              <div className="text-gray-400 text-xs">Carte numerique avec QR Code</div>
            </div>
            <div className="bg-[#111] border border-gold/20 rounded-2xl p-6 hover:border-gold/60 transition-colors">
              <div className="text-4xl mb-3">cup</div>
              <div className="text-gold font-bold text-sm mb-1">Competitions officielles</div>
              <div className="text-gray-400 text-xs">Juges experts et reglements clairs</div>
            </div>
            <div className="bg-[#111] border border-gold/20 rounded-2xl p-6 hover:border-gold/60 transition-colors">
              <div className="text-4xl mb-3">team</div>
              <div className="text-gold font-bold text-sm mb-1">Communaute passionnee</div>
              <div className="text-gray-400 text-xs">Echange, partage et entraide</div>
            </div>
            <div className="bg-[#111] border border-gold/20 rounded-2xl p-6 hover:border-gold/60 transition-colors">
              <div className="text-4xl mb-3">book</div>
              <div className="text-gold font-bold text-sm mb-1">Ressources et documents</div>
              <div className="text-gray-400 text-xs">Guides, conseils, formations</div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-black border-t border-gold/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white mt-2 mb-8">
            L ORGANISATION CYNOPHILE <span className="text-gold">DES CARAIBES</span>
          </h2>
          <p className="text-gray-300 text-lg leading-relaxed mb-8">
            Le KBFC a pour mission de promouvoir les races canines, encourager un elevage responsable,
            organiser des evenements de qualite et rassembler les passionnes autour de valeurs fortes :
            respect, excellence, bien-etre animal, culture et solidarite.
          </p>
          ...
          <div className="flex flex-col md:flex-row justify-between gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-500 text-sm max-w-xs">
                L organisation cynophile officielle des Caraibes. Unir la Caraibe, celebrer nos chiens, valoriser notre culture.
              </p>
            </div>
